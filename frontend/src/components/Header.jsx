  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
        ...
        >
          <span className="font-display font-black tracking-tight text-white text-sm uppercase tracking-[0.18em]">
            BRANDLY SYSTEMS
          </span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="hidden md:inline-flex pill-light h-10 px-5 text-sm"
          >
            Contact Us
          </button>
          <button
        ...
        <div className="md:hidden border-t border-white/5 bg-black/95 backdrop-blur-xl">
          <div className="px-6 py-5 flex flex-col gap-4">
            {links.map((l) =>
              l.href ? (
                ...
                <button
                  ...
                  className="text-base text-white/70 hover:text-white text-left"
                >
                  {l.label}
                </button>
              )
            ...
            <button
              ...
              className="pill-light h-11 px-5 w-full text-sm mt-2"
            >
              Contact Us
            </button>
          </div>
