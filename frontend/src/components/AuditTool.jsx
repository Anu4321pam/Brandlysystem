  ...
  return (
    <div className="relative h-36 w-36 flex-shrink-0">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="font-display text-4xl text-white">{pct}</div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          <button
            ...
            className={`text-left rounded-2xl p-7 transition-all border ${
              tab === "website"
                ? "bg-gradient-to-br from-indigo-500/15 via-[#0a0a0a] to-[#0a0a0a] border-indigo-400/40"
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <span className="text-[10px] uppercase tracking-widest font-mono text-emerald-300">
                Free
              </span>
            </div>
            ...
            >
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="h-13 py-3.5 pl-10 text-base bg-white/[0.03] border-white/10 text-white placeholder:text-white/30 focus-visible:ring-indigo-400/40 focus-visible:border-indigo-400/40"
                />
              </div>
              <button
                type="submit"
            ...
            <form onSubmit={runGmb} data-testid="gmb-audit-form" className="space-y-3">
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    className="h-13 py-3.5 pl-10 bg-white/[0.03] border-white/10 text-white placeholder:text-white/30 focus-visible:ring-indigo-400/40 focus-visible:border-indigo-400/40"
                  />
                </div>
                <button
                  type="submit"
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <Input
                  ...
                  className="h-11 bg-white/[0.02] border-white/10 text-white placeholder:text-white/25"
                />
                <Input
        ...
        <AnimatePresence>
          {loading && (
            ...
            >
              <Loader2 className="animate-spin mx-auto text-indigo-300" size={28} />
            ...
            >
              ...
              <div className="surface p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="mt-2 text-white/60 max-w-xl">{report.summary}</p>
                  <div className="mt-4 flex flex-wrap gap-3 justify-center md:justify-start">
                    ...
                    <span className="inline-flex items-center gap-2 text-sm px-3 h-8 rounded-full bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">
              ...
              <div className="mt-6 relative">
                ...
                {unlocked && (
                  <motion.div
                    ...
                    className="mt-8 rounded-2xl p-6 md:p-8 bg-gradient-to-br from-indigo-500/15 via-[#0a0a0a] to-[#0a0a0a] border border-indigo-400/30"
                  >
