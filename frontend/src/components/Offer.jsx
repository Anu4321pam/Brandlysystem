    ...
    >
      <div className="relative max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 border border-[#0055fe]/40 px-4 py-1.5 mb-6">
            <Flame size={11} className="text-[#0055fe]" />
            <span className="text-[10px] uppercase tracking-[0.25em] text-[#0055fe] font-mono">
        ...
        <motion.div
          ...
          className="relative bg-[#0d0d0d] border border-[#1f1f1f] champagne-top-border overflow-hidden"
        >
          <div className="relative grid lg:grid-cols-12">
            {/* LEFT — What's included */}
            <div className="lg:col-span-7 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-[#1f1f1f]">
              <div className="text-[10px] uppercase tracking-[0.3em] text-[#0055fe] font-mono mb-5">
                — What's inside
              </div>
              <h3 className="font-display text-3xl text-[#ffffff] mb-8">
              ...
              <ul className="space-y-5">
                {coreStack.map((item, i) => (
                  <motion.li
                    ...
                    className="flex items-start gap-4 pb-5 border-b border-[#1f1f1f] last:border-b-0 last:pb-0"
                  >
                    <span className="h-5 w-5 border border-[#0055fe]/50 text-[#0055fe] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Check size={11} strokeWidth={2} />
                    </span>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline justify-between gap-4 flex-wrap">
                        <div className="font-medium text-[#ffffff] text-[15px]">
                          {item.title}
                        </div>
                        <div className="text-[11px] text-[#999999] font-mono whitespace-nowrap">
                          {format(item.value)} value
                        </div>
                      </div>
                      <p className="mt-1.5 text-sm text-[#999999] leading-relaxed font-body">
                        {item.desc}
                      </p>
                    </div>
                  </motion.li>
              ...
              <h3 className="font-display text-3xl text-[#ffffff] mt-12 mb-8">
              ...
              <ul className="space-y-4">
                {bonuses.map((b, i) => (
                  <motion.li
                    ...
                    className="p-5 bg-[#0055fe]/[0.04] border border-[#0055fe]/20"
                  >
                    <div className="flex items-baseline justify-between gap-4 flex-wrap">
                      <div className="font-medium text-[#ffffff]">
                        {b.title}
                      </div>
                      <div className="text-[11px] text-[#0055fe]/70 font-mono whitespace-nowrap">
                        {format(b.value)} value
                      </div>
                    </div>
                    <div className="mt-1.5 text-xs italic text-[#0055fe]/80 font-display-italic">
                      {b.why}
                    </div>
                    <p className="mt-2 text-sm text-[#999999] leading-relaxed font-body">
                      {b.desc}
                    </p>
                  </motion.li>
                ))}
            ...
            <div className="lg:col-span-5 p-8 md:p-12 bg-gradient-to-br from-[#0055fe]/[0.06] via-transparent to-transparent">
              <div className="text-[10px] uppercase tracking-[0.3em] text-[#999999] font-mono">
                Total value
              </div>
              <div
                className="mt-3 font-display text-4xl text-[#999999]/50 line-through decoration-[#0055fe]/60 decoration-[1px]"
                data-testid="offer-total-value"
              >
                {format(total)}
              </div>

              <div className="mt-10 text-[10px] uppercase tracking-[0.3em] text-[#0055fe] font-mono">
                Your price today
              </div>
              <div className="mt-3 flex items-baseline gap-3 flex-wrap">
                ...
                <div className="text-[#999999] font-display-italic text-xl">
                  for 14 days
                </div>
              </div>
              <p className="mt-4 text-sm text-[#999999] leading-relaxed font-body">
                After your trial:{" "}
                <span className="text-[#ffffff] font-semibold">$497/mo</span>{" "}
                — locked in as a founding rate.{" "}
                <span className="text-[#999999]/60 line-through">$697/mo</span>{" "}
              ...
              <div
                ...
                className="mt-10 p-6 bg-[#0055fe]/[0.04] border border-[#0055fe]/30"
              >
                <div className="flex items-center gap-3 mb-3">
                  <Shield size={18} className="text-[#0055fe]" strokeWidth={1.5} />
                  <div className="font-display text-xl text-[#ffffff]">
                    The 20-Jobs{" "}
                    <span className="font-display-italic">Guarantee</span>
                  </div>
                </div>
                <p className="text-sm text-[#999999] leading-relaxed font-body">
              ...
              <div
                ...
                className="mt-6 p-5 border border-[#0055fe]/30 flex items-start gap-3"
              >
                <Clock
                  size={16}
                  className="text-[#0055fe] mt-0.5 flex-shrink-0"
                  strokeWidth={1.5}
                />
                <div className="text-sm">
                  ...
                  <div className="text-[#999999] mt-1 font-body">
              ...
              <p className="mt-4 text-center text-[10px] text-[#999999] font-mono tracking-[0.15em] uppercase">
